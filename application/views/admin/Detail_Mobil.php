  ...
  <?php foreach ($detail as $dt) : ?>
    <div class="card">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-5">
            <img style="max-height: 325px;justify-content: center;position: fixed;align-content: center;align-items: center;" src="<?php echo base_url() . 'assets/upload/' . $dt->gambar ?>">
          </div>
          <div class="col-md-7">
            <table class="table">
              <tr>
